  ...
  <div class="row">
    ...
    <div class="col-xs-6 vellum">
      ...
      <img src="images/nature.png" alt="Logo" class="logo img-responsive"> 
        ...
        <a href="login.php"> <button type="button" class="btn btn-default btn-lg btn-block">Log In </button></a>
        <a href="apply-main.php"> <button type="button" class="btn btn-default btn-lg btn-block">Sign Up </button></a>
    </div><!--End vellum box-->
  </div><!--End row-->
